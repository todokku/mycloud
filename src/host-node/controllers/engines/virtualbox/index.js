   ...
   /**
    ...
    static async deployNewCluster(dbHostNode, workspaceId, rUser, rPass, eventCb) {
        ...
        try{
            ...
            let resultCd = await OSController.sshExec(masterIpHost[0], [
    ...
    static async deployWorker(topicSplit, payload, rUser, rPass) {
        ...
        try{
            ...
            await OSController.sshExec(workerIpHost[0], `printf "${rPass}" | docker login registry.mycloud.org --username ${rUser} --password-stdin`, true);
